...
Route::prefix('admin')->name('admin.')->middleware('isAdmin')->group(function (){
    ...
    Route::get('/harddelete/{id}','App\Http\Controllers\Back\ArticleController@hardDelete')->name('hard.delete.article');
...
Route::get('/giris-yap' ,'App\Http\Controllers\Back\UserController@login')->name('page.login');
Route::get('/kayit', 'App\Http\Controllers\Back\UserController@registerpage')->name('page.register');
Route::post('/kayit', 'App\Http\Controllers\Back\UserController@register')->name('user.register');
